            ...
            .map((itemFilm, index) => (
              ...
              >
                <img
                  ...
                  className="object-cover object-center w-full rounded-t-md h-44 lg:h-52 "
                />
                <div className="flex flex-col justify-between p-4 ">
                  <h2 className="film-name-card-mobile font-semibold mb-2">
                    {itemFilm.tenPhim.length > 22
                  ...
                  <button
                    onClick={() => navigate(`detail/${itemFilm.maPhim}`)}
                    className="flex items-center justify-center w-full p-2 lg:p-3 font-semibold rounded-md bg-yellow-500 text-gray-50"
                  >
                    Đặt vé
                  </button>
                </div>
