...
export default function Login() {
    ...
    return (
        <>
            {getLocalStorage(LOCALSTORAGE_USER) ? <PageNotFound /> : <div className='login'>
                ...
                <form onSubmit={handleSubmit} className="form rounded-lg bg-white p-2 sm:p-4  md:p-8">
                    ...
                    <div className="form-control">
                        <input placeholder="none" title='Tài khoản' onChange={HandleChangeInput} type="text" name="taiKhoan" className="form-input"  />
                        <label className="form-label bg-white">Tài khoản</label>
                    </div>
                    <p className='form-err font-medium mb-4 mt-1'>{state.err.taiKhoan}</p>
                    <div className="form-control mt-6">
                        <input placeholder="none" title='Mật khẩu' onChange={HandleChangeInput} id='matKhau' type="password" name="matKhau" className="form-input" />
