...
import {Layout, Layouy, Menu} from "antd"
...
import {MenuFoldOutlined, MenuUnfoldOutlined, SnippetsOutlined, UserOutlined, FileAddOutLined} from '@ant-design/icons';
...
return (
    ...
    <div className="hidden x:block">
        <Layout className="mn-h-screen">
        <Sider trigger ={null} collapsible collapsed={collapsed} className=''>
        <NavLink to='/' arial-label="Back to homepage" className='flex items-center justify-center p-2'>
        ...
        <Header className="site-layout-background pl-4 text-[1.8rem]"></Header>
        </Layout>
        </Layout>
    </div>
    </>}
